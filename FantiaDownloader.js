...
(function () {
	...
	.unBlur {
		background-color: #6d6e6eed   !important;
	...
	<div class="titleImage" onclick="location.href = 'https://github.com/suzumiyahifumi/Fantia-Downloader-tampermonkey'" style="width: 100%;height: 45px;background-color: #7878789e;position: relative;margin: 10px auto;cursor: pointer;"></div>
