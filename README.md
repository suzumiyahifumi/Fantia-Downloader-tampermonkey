...
* 可以取得瀏覽器擴充版本（You can get extension version for Firefox and Chrome）：
  1. Firefox：[Fantia downloader Firefox (ver2.7.3)](https://addons.mozilla.org/zh-TW/firefox/addon/fantia-downloader/)
  ...
  * Version 2.7.3 for Chrome will be come soon.<br>
