...
* 可以取得瀏覽器擴充版本（You can get extension version for Firefox and Chrome）：
  1. Firefox：[Fantia downloader Firefox (ver3.1.9)](https://addons.mozilla.org/zh-TW/firefox/addon/fantia-downloader/)
  2. Chrome： [Fantia downloader Chrome (ver3.1.8)](https://chrome.google.com/webstore/detail/fantia-downloader/cfkejojncmolgahkabegcdbcbmnghhcp?hl=zh-TW&authuser=0) <br>
...
You can install this script from greasyfork ([Fantia downloader (ver3.1.9)](https://greasyfork.org/zh-TW/scripts/423306-fantia-downloader)).<br>
<br>
